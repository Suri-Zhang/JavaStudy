...
public class BattleGrid {
    ...
    private BattleGrid(final String[] args) {
        if ((args != null) && (args.length > 2)) {
            ...
            shipRow = rnd.nextInt(gridSize);
            shipCol = rnd.nextInt(gridSize);
        }
    }
     ...
     * 
     * @throws InvalidLocationException This exception is thrown if
     *                                             both the row and column
     *                                             guessed are incorrect.
     * 
     * @throws InvalidRowException      This exception is thrown if
     *                                             the row guessed is incorrect.
     * 
     * @throws InvalidColException      This exception is thrown if
     *                                             the column guessed is
     *                                             incorrect.
     * 
     * @throws IllegalLocationException This exception is thrown if
